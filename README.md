...
Please use this [link](https://drive.google.com/drive/folders/1XUIxcN73JT_KacUcEtZkyJR42uPFnzPV?usp=drive_link) to download all the datasets used for eval in the bash script. Place the `ambig` folder at root level `data` folder in this repo.
